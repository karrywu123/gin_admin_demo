...
import (
	...
	"gin_admin_demo/comment/loggers"
	"gin_admin_demo/controllers"
...
func (con *AdminSystemController) Index() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.HTML(http.StatusOK, "views/template/setting/systemlog.html", gin.H{
			"log_path": path,
			"files":    files,
...
func (con *AdminSystemController) View() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.HTML(http.StatusOK, "views/template/setting/systemlog_view.html", gin.H{
			"file_path":    filePath,
